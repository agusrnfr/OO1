...
class EmpleadoTest {
	...
	void setUp() throws Exception {
		...
		this.empleadoConContratoVencido.cargarContratoPorHoras(LocalDate.of(2015, 9, 20), LocalDate.of(2022, 10, 23), 100, 100);
		this.empleadoConContratoVencido.cargarContratoPorHoras(LocalDate.of(2022, 9, 20), LocalDate.of(2022, 10, 23), 100, 100); 
		this.empleadoSinContratoVencido.cargarContratoDePlanta(LocalDate.of(2022, 10, 24), 100, 100, 100);
		this.empleadoSinContratoVencido.cargarContratoPorHoras(LocalDate.of(2015, 9, 20), LocalDate.of(2022, 10, 23), 100, 100);
		this.empleadoSinContratoVencido.cargarContratoPorHoras(LocalDate.of(2022, 9, 20), LocalDate.of(2022, 10, 23), 100, 100);
		
		this.empleado4Años.cargarContratoPorHoras(LocalDate.of(2015, 9, 20), LocalDate.of(2017, 10, 23), 100, 100);
		this.empleado4Años.cargarContratoPorHoras(LocalDate.of(2018, 11, 02), LocalDate.of(2020, 11, 02), 100, 100);
		...
		this.empleado10Años.cargarContratoDePlanta(LocalDate.of(2022, 10, 24), 100, 100, 100);
		this.empleado15Años.cargarContratoPorHoras(LocalDate.of(2007, 9, 20), LocalDate.of(2012, 10, 23), 100, 100); 
		this.empleado15Años.cargarContratoDePlanta(LocalDate.of(2012, 10, 24), 100, 100, 100);
		this.empleado20Años.cargarContratoPorHoras(LocalDate.of(2002, 9, 20), LocalDate.of(2022, 10, 23), 100, 100);
		this.empleado20Años.cargarContratoPorHoras(LocalDate.of(2022, 10, 23), LocalDate.of(2024, 11, 23), 100, 100);
	...
	void testCalcularMontoTotal() {
		assertEquals(0,this.empleado4Años.calcularMontoTotal()); //TIENE CONTRATO VENCIDO
		assertEquals(260,this.empleado5Años.calcularMontoTotal());
		assertEquals(300,this.empleado10Años.calcularMontoTotal());
