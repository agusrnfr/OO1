...
class DePlantaTest {
	...
	void setUp() throws Exception {
		this.conHijos = new DePlanta (new Empleado ("Jose","Diaz","123",LocalDate.of(2002, 10, 24),false, true), LocalDate.of(2012, 10, 24), 100, 100, 100);
	...
	void testCalcularAnios() {
		assertEquals(10,conHijos.calcularAnios());
	}
