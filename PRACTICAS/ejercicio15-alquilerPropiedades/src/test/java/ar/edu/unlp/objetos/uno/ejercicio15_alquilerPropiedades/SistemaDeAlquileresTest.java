...
class SistemaDeAlquileresTest {
	...
	void setUp() throws Exception {
		...
		this.propiedad1 = this.sistema.registrarPropiedad("Propiedad1", "abc" , "Avenida Siempre Viva 742", 500, propietario1);
		this.propiedad2 = this.sistema.registrarPropiedad("Propiedad2", "bca" , "Avenida San Martin 421", 200, propietario1);
